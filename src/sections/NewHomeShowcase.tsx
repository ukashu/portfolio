...
export default function GoodTeacherShowcase() {
  return (
    <div className=" left-0 top-0 flex max-h-[100vh] flex-1 flex-row justify-between gap-12 overflow-hidden p-12">
      <div className=" h-100% bg-transparent flex w-8/12 flex-row flex-wrap items-center justify-around rounded-3xl">
        <img src={newHomeShowcase} className="h-auto max-w-[100%] object-contain drop-shadow-lg"></img>
      </div>
      <div className="w-100% flex w-4/12 flex-col items-center justify-between gap-12">
        ...
        <div className=" w-100% flex flex-grow flex-col justify-around rounded-3xl bg-nh-grey-light bg-opacity-80 p-6">
          <div>
            <h1 className=" pb-6 text-center text-xl font-semibold">Productivity focused Chromium extensions</h1>
